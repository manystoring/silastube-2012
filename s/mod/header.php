...
<div id="masthead" class="" dir="ltr">
  <a id="logo-container" href="/" title="SilasTube home">
  <img id="logo" src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="SilasTube home">
  </a>
...
Shroogle account
        ...
        <div id="masthead-expanded-menu-google-container">
            <img id="masthead-expanded-menu-gaia-photo" alt="" data-src="/dynamic/pfp/<?php echo $__user_h->fetch_pfp($_SESSION['siteusername']); ?>">
  <div id="masthead-expanded-menu-account-info" class="email-only">
    ...
    <p id="masthead-expanded-menu-email">This Is You</p>
      ...
      <div id="masthead-expanded-menu-google-column1">
        <ul>
          <li class="masthead-expanded-menu-item"><a href="http://idk.silastube.serv00.net">Profile</a></li>
          <li class="masthead-expanded-menu-item"><a href="http://idk.silastube.serv00.net">Shroogle+</a></li>
          <li class="masthead-expanded-menu-item"><a href="http://idk.silastube.serv00.net">Privacy</a></li>
        </ul>
      </div>
...
Settings
          ...
          <li class="masthead-expanded-menu-item">
            <a class="end" href="/logout" onclick="document.logoutForm.submit(); return false;">
Sign out
            </a>
          </li>
              <li class="masthead-expanded-menu-item">
                  ...
                  <div class="yt-uix-clickcard-content">
                    <ul id="yt-masthead-multilogin">
                      <li>
                        ...
                        <img alt="<?php echo htmlspecialchars($_SESSION['siteusername']); ?>" src="/dynamic/pfp/<?php echo $__user_h->fetch_pfp($_SESSION['siteusername']); ?>" width="46">
                    ...
                    <div id="yt-masthead-multilogin-actions" class="yt-grid-box">
                      ...
                      <a href="/AddSession?service=silastube&amp;uilel=0&amp;cont…er%252Bballoon%252Bfight%26nomobiletemp%3D1&amp;hl=en_US&amp;passive=false">Add account</a>
                    </div>
                  </div>
                </div>
              </li>
