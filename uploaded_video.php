...
?>
<?php
	$__server->page_embeds->page_title = "KamTube - Refresh Yourself.";
	$__server->page_embeds->page_description = "Share your videos with friends, family, and the world";
	$__server->page_embeds->page_image = "/yt/imgbin/full-size-logo.png";
	$__server->page_embeds->page_url = "http://kamtube.rf.gd/";
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<div id="page" class="">
			...
			<div id="content-container">
				...
				<div id="content">
                    ...
                    <input id="video-link" style="width: 300px;" placeholder="Video Link" class="upload-input" type="text" value="http://kamtube.rf.gd/watch?v=<?php echo $_video['rid']; ?>" name="title"><br><br>
                    <br>
                </div>
            </div>  
