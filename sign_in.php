...
<?php
  $__server->page_embeds->page_title = "SilasTube - Sign In";
    ...
    <div id="page" class="">
      ...
      <div id="content-container">
        ...
        <div id="content" style="">
                    ...
                    <br>
          <div class="www-left">
            <b>Join the Awesomest video-sharing community!</b><br>
            Sign up now to get full access with your SilasTube account: <br><br>
            <ul>
            ...
            </ul><br><a href="/sign_up">Sign up now </a> to join the SilasTube community.<br>
<br><br>
          </div>
          <div class="www-right">
