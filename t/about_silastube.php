            ...
            <div class="ytg-fl browse-content">
              ...
              <div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
                <div class="browse-collection  has-box-ad">
                  <h1>About SilasTube</h1>
                  <hr><br>
                  <p class="intro-text" style="line-height: 18px;margin-bottom: 20px;">
                    Founded in The Year 2022, SilasTube allows hundreds of people to discover, watch and share (mostly) originally-created videos.
                    SilasTube provides a forum for people to connect, inform, and inspire others across the globe and acts as a distribution platform for original content creators. 
                    SilasTube is the direct successor of CyanTube, A 2006 Revival Made By CJSL2018<br><br>
                    The SilasTube staff team hopes you enjoy your time on this small site.
                  </p>
                                </div>
              </div>
            </div>
