...
<?php
  $__server->page_embeds->page_title = "SilasTube - About";
            ...
            <div class="ytg-fl browse-content">
              ...
              <div id="browse-main-column" style="float: right;margin: 0px 0 0 14px;" class="ytg-4col">
                <div class="browse-collection  has-box-ad">
                                    ...
                                    SubRocks respects the rights of copyright holders and publishers and requires all users to confirm they own the copyright or have permission from the copyright holder to upload content. We comply with the Digital Millennium Copyright Act (DMCA) and other applicable copyright laws and promptly remove content when properly notified.

                                    Posting copyright-infringing content can lead to the removal of your videos and possibly monetary damages if a copyright owner decides to take legal action (this is serious—you can get sued!). Repeat infringers' accounts are terminated. These users are permanently prohibited from using SubRocks.

                                    SubRocks hopes that you will help us protect the rights of artists and creators, and work with us to keep our community a creative, legal and positive experience for everyone.
                                    </p>
                                </div>
              </div>
            </div>
