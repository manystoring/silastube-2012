...
<?php ob_start(); ?>
<?php
  $__server->page_embeds->page_title = "SilasTube - Popularize Yourself.";
            ...
            <?php if(!isset($_SESSION['siteusername'])) { ?>
              ...
              Sign in to add channels to your homepage
                ...
                <div id="guide-builder-promo-buttons" class="">
                  <button href="/channels" type="button" onclick=";window.location.href=this.getAttribute('href');return false;" role="button" class=" yt-uix-button  yt-uix-button-primary"><img src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" class="yt-uix-button-icon-add"><span class="yt-uix-button-content"> Browse channels</span></button>
                </div>
                <?php } ?>
              </div>
              <div class="guide">
...
<div id="channel">
                  <span id="channel-thumb">
                    <a href="/user/<?php echo htmlspecialchars($_SESSION['siteusername']); ?>?feature=guide" class="yt-user-photo ">
                      <span class="video-thumb ux-thumb yt-thumb-square-77 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img src="/dynamic/pfp/<?php echo $__user_h->fetch_pfp($_SESSION['siteusername']); ?>" alt="<?php echo htmlspecialchars($_SESSION['siteusername']); ?>" width="77"><span class="vertical-align"></span></span></span></span>
                    </a>
                  </span>
                  <div id="personal-feeds">
                    <ul>
                      <li class="guide-item-container"><a class="guide-item guide-item-action" href="/user/<?php echo htmlspecialchars($_SESSION['siteusername']); ?>?feature=guide">My channel<img src="//s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" class="see-more-arrow" alt=""></a></li>
                      <li class="guide-item-container"><a class="guide-item" data-feed-name="uploads" data-feed-type="personal" title="Videos you have uploaded">Videos</a></li>
                      <li class="guide-item-container"><a class="guide-item" data-feed-name="likes" data-feed-type="personal" title="Videos you have liked">Likes</a></li>
                      <li class="guide-item-container"><a class="guide-item" data-feed-name="history" data-feed-type="personal" title="Videos you have watched">History</a></li>
                      <li class="guide-item-container"><a class="guide-item" data-feed-name="watch_later" data-feed-type="personal" title="Videos you have added to your Watch Later list">Watch Later</a></li>
                    </ul>
                  </div>
                                    <div id="guide-reminders">
                    <ul>
                                                                       <li class="guide-reminder">
                          <div class="upgrade">
                            <div class="guide-reminder-icon"></div>
                            <div class="guide-reminder-text">
                              Upgrade account
                            </div>
                          </div>
                        </a>
...
<div class="guide-section yt-uix-expander  ">
                <ul>
                  <li class="guide-item-container yt-uix-expander">
                    <a class="guide-item" data-feed-name="subscriptions" data-feed-type="system">
                    <span class="thumb">
                    <img class="system-icon system subscriptions" src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="">
                    </span>
                  ...
                  <li class="guide-item-container ">
                    <a class="guide-item" data-feed-name="social" data-feed-type="system">
                    <span class="thumb">
                    <img class="system-icon system social" src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="">
                    </span>
                    <span class="display-name">
                      Social
                    </span>
                                            ...
                                            <span class="thumb">  <span class="video-thumb ux-thumb yt-thumb-square-28 "><span class="yt-thumb-clip"><span class="yt-thumb-clip-inner"><img src="https://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="Thumbnail" onerror="this.onerror=null;this.src='/dynamic/thumbs/default.jpg';" data-thumb="/dynamic/pfp/<?php echo $__user_h->fetch_pfp($channel); ?>" width="28"><span class="vertical-align"></span></span></span></span></span>
                                            <span class="display-name">
                                                <?php echo htmlspecialchars($channel); ?>                                            </span>
                                            </a>
                                        </li>
                                            <?php } ?>
                                        <?php } ?>                                                
                ...
                <div class="guide-item-container">
                  <span class="guide-item guide-item-action guide-item-fake">
                    <a href="/subscriptions">see all<img src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" class="see-more-arrow" alt=""></a>
                  </span>
                </div>
                                </div>
                <?php } ?>
<div class="guide-section yt-uix-expander  first yt-uix-expander-collapsed">
            ...
            <div id="video-sidebar">
              ...
              <h2>Site is Getting Worked On!!!</h2>
              <p class="sidebar-module-description">
                We Are Fixing Bugs And Adding New Stuff
              </p>
              <p class="sidebar-module-description">
                Presented by: <a href="/user/TehEpikDuck">TehEpikDuck</a>
              </p>
              <ul>
                <?php
